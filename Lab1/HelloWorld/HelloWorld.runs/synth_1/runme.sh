...
HD_PWD='C:/Users/Isabella Phung/Documents/CSE100/Lab 1/HelloWorld/HelloWorld.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log AN0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source AN0.tcl
